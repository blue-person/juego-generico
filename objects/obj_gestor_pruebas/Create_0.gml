...
// Creacion de la suite para las pruebas de las fisicas
suite_pruebas_fisicas = new TestSuite("pruebas_fisicas");
// Agregar la suite al runner de pruebas
runner.addTestSuite(suite_pruebas_fisicas);
// Realizar todas las pruebas que inicien por "pruebas_fisicas_"
runner.discover(suite_pruebas_fisicas, "pruebas_fisicas_");
